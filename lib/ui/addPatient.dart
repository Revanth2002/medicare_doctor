...
class AddPatientMobile extends StatefulWidget {

  @override
  _AddPatientMobileState createState() => _AddPatientMobileState();
}

class _AddPatientMobileState extends State<AddPatientMobile> {

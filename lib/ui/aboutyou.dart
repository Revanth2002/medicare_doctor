      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            ...
            child: StreamBuilder(
              stream: db.collection("users").doc(userUid.uid).collection("profile").snapshots(),
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            trailing: InkWell(
                                ...
                                borderRadius: BorderRadius.circular(40),
                                onTap: (){
                                  update(context,snapshot.data.docs[index].id,"mail","Email",_emailController,50,TextInputType.emailAddress);
                                },
                                child: Icon(Icons.edit,color: Colors.grey,)),
                            title:Text(

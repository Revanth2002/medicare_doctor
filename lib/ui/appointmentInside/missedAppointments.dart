...
class MissedAppointmentMQ extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints){
        if(constraints.maxWidth>1280){
          return MissedAppointmentDesktop();
        }
        else if(constraints.maxWidth>840 && constraints.maxHeight<1280){
          return MissedAppointmentTablet();
        }
        else{
          return MissedAppointmentMobile();
        }
      },
    );
  }
...
class MissedAppointmentDesktop extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container();
  }
}
class MissedAppointmentTablet extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container();
  }
...
class MissedAppointmentMobile extends StatefulWidget {
  @override
  _MissedAppointmentMobileState createState() => _MissedAppointmentMobileState();
}

class _MissedAppointmentMobileState extends State<MissedAppointmentMobile> {
            ...
            child: Stack(
              ...
              children: [
                Stack(
                      ...
                      child: Stack(
                        children: [
                          Row(
                            ...
                            children: [
                              Image.asset("assets/images/missed-1.jpg",fit: BoxFit.cover,height: 200,width:size.width),
                  ...
                  child: StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("users").doc(userUid.uid).collection("missed").orderBy('date',descending: true).snapshots(),
